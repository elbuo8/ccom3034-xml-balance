...
# Generated by qmake (2.01a) (Qt 4.7.0) on: Tue Oct 16 21:13:42 2012
...
dist: 
	...
	$(COPY_FILE) --parents $(SOURCES) $(DIST) .tmp/xml-bal021.0.0/ && $(COPY_FILE) --parents xmlfile.h .tmp/xml-bal021.0.0/ && $(COPY_FILE) --parents xmlfile.cpp main.cpp .tmp/xml-bal021.0.0/ && (cd `dirname .tmp/xml-bal021.0.0` && $(TAR) xml-bal021.0.0.tar xml-bal021.0.0 && $(COMPRESS) xml-bal021.0.0.tar) && $(MOVE) `dirname .tmp/xml-bal021.0.0`/xml-bal021.0.0.tar.gz . && $(DEL_FILE) -r .tmp/xml-bal021.0.0
...
xmlfile.o: xmlfile.cpp xmlfile.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o xmlfile.o xmlfile.cpp

main.o: main.cpp xmlfile.h
